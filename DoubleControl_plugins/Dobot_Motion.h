#ifndef DOBOT_MOTION_H
#define DOBOT_MOTION_H
...
class Dobot_Motion : public ARM_Motion
{
public:
    Dobot_Motion();
public:
    ...
    int planner_BufferLine(const float *target, Gcode_segment &userData, ARM_SendState *send_signal);
    void loopRun();
    void Motor_Reset();
