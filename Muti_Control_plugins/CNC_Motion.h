...
typedef struct DH_arrayParam_s{
    float **DH_param_ptr;
    int dof_num;
    int param_num;

    DH_arrayParam_s(){
        DH_param_ptr = nullptr;
        dof_num = 0;
        param_num = 0;
    }
}DH_arrayParam_s;
...
public:
    ...
    bool m_limit_state[6];//M指令中限位开关的状态
    ...
    void renew_robotDH_ptr(Robot_parameter_s &robot_DH);
...
private:
    ...
    DH_arrayParam_s m_DH_arrayParam;
};
