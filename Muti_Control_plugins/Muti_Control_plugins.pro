...
DISTFILES += Muti_Control_plugins.json
...
#    ControlTab_P.cpp \
    ...
    CNC_Motion.cpp \
    Excel_Object.cpp \
    Form_Robot_Parameter.cpp \
    Algorithm_loader.cpp \
    AppUser_Message.cpp
