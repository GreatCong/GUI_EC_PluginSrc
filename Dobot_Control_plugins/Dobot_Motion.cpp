...
#define DEFAULT_Z_STEPS_PER_UNIT 			88.89f//89.00//90.87f//86.48f
...
#define SMALL_ARM_LENGTH 170			//	@小臂长度	170mm
#define HEAD_OFFSET   52				//	@头偏移	48.8mm
...
/// \brief 复位
///
void Dobot_Motion::Arm_motion_reset(bool isCalibrate)
{
...
/// \return
///
int Dobot_Motion::planner_BufferLine(const float * target, const Gcode_segment &userData, ARM_SendState *send_signal){
...
//    calculate_forward(print_position);
    ...
    //NOTE:为了让Dobot的X轴以0为初始点，这里要减去偏移量
    send_signal->position_send->arm[AXIS_X] -=  m_PositionInit->arm[AXIS_X];
